<div class="main-page">
    <div class="container-fluid bg-white">
        ...
        <form method="post" action="<?= base_url('fria03/edt_process')  ?>" enctype="multipart/form-data">
            <div class="row panel">
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <textarea class="textarea" name="pertanyaan" placeholder="Silahkan tulis pertanyaan anda" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" autofocus><?= $datafr['pertanyaan'] ?></textarea>
                        </div>
                        <div class="form-group has-feedback">
