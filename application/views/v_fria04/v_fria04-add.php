<div class="main-page">
    <div class="container-fluid bg-white">
        ...
        <form method="post" action="<?= base_url('fria04/add_process')  ?>" enctype="multipart/form-data">
            <div class="row panel">
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <textarea class="textarea" name="hasil" placeholder="Silahkan tuliskan SOP disini" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" autofocus></textarea>
                        </div>
                        <div class="form-group has-feedback">
                            <label for="username5">Hal yang perlu didemonstrasikan</label>
                            <textarea class="textarea" name="demonstrasi" placeholder="Silahkan tuliskan SOP disini" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" autofocus></textarea>
                        </div>
                        <div class="form-group has-feedback">
