<div class="main-page">
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-md-6">
                <h4 class="title">FR.APL-02. ASESMEN MANDIRI</h4>
        ...
        <div class="row mt-30">
            <div class="col-md-4">
                        ...
                        <div class="row">
                            <table class="table table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Tanda Tangan</th>
                                        <td><img src="<?= $dataapl02['ttd_asesi'] ?>" width="100%"></td>
                                    </tr>
                                    <tr>
                                        <th>Tanggal Pengajuan</th>
                                        <td><?= $dataapl02['tgl_ajuan'] ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="panel border-primary no-border border-3-top">
                    ...
                    <form action="<?= base_url('ujikom/apl02_process') ?>" method="POST">
                        <div class="panel-body">
                            <div class="row">
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <td>Keputusan Asesor proses Asesesmen :</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="mb-10">
                                                    <input type="radio" name="status_ajuan" id="one" class="blue-style" value="2">
                                                    <label for="one" class="radio-label">Dapat dilanjutkan</label>
                                                </div>
                                                <div class="mb-10">
                                                    <input type="radio" name="status_ajuan" id="two" class="red-style" value="3">
                                                    <label for="two" class="radio-label">Tidak dapat dilanjutkan</label>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>sebagai peserta sertifikasi</td>
                                        </tr>
                                        <tr>
                                            <td>Tanda tangan:</td>
                                        </tr>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $hadkom = $this->db->query("SELECT count(*) as jml_k from tb_apl_02 where id_unit='" . $du->id . "' and id_asesi='" . $idasesi . "' and kompetensi='K'")->row_array();
                                            echo $hadkom['jml_k'] . " Elemen K<br>";
                                            $hadkom = $this->db->query("SELECT count(*) as jml_k from tb_apl_02 where id_unit='" . $du->id . "' and id_asesi='" . $idasesi . "' and kompetensi='BK'")->row_array();
                                            echo $hadkom['jml_k'] . " Elemen BK";
                                            ?>
                                        </td>
                                    </tr> <?php
                                            $No++;
