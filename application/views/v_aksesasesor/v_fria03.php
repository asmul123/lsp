                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5>FR.IA.03. PERTANYAAN UNTUK MENDUKUNG OBSERVASI</h5>
                                <hr>
                        ...
                        <div class="panel-body p-20">
                            ...
                            <hr>
                            <form action="<?= base_url('aksesasesor/ia03save') ?>" method="POST">
                                <table id="dataSiswaIndex" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($datafria03 as $data) {
                                            ...
                                            $dataia = $this->Maksesasesor->getRefIa03($data->id, $dataasesi['idas']);
                                        ?>
                                            <tr>
                                                <td width="6%" align="center"><?= $No ?>.</td>
                                                <td width="81%">(<?= $dataunit['kode_unit'] ?>) <?= $data->pertanyaan ?></td>
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    Tanggapan:
                                                    <p><textarea name="jawaban<?= $data->id ?>" class="form-control"><?php if ($dataia) {
                                                                                                                            echo $dataia['jawaban'];
                                                                                                                        } ?></textarea></p>
                                                </td>
                                            </tr>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                ...
                                                <p><textarea name="umpan_balik" class="form-control"><?php if ($dataia) {
