                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body p-20">
                            ...
                            <a href="<?= base_url('fria06/tambah/' . $dataskema['id'])  ?>" class="btn btn-primary mb-20">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="min-width: 110px">
                                                <div class="btn-group">
                                                    <a href="<?= base_url('fria06/ubah/') . $data->id;  ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                                    <a href="<?= base_url('fria06/hapus/') . $data->id . '/' . $dataskema['id'] ?>" class="btn btn-danger" onclick="return confirm('Yakin untuk menghapus?')"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
