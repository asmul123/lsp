...
class Asesi extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('v_asesi/v_asesi', $data);
	...
	public function export()
	{
		...
		try {
			...
			$spreadsheet->getProperties()
				...
				->setDescription(
					"Data Asesi LSP P1 SMKN 4 GARUT"
				)
	...
	public function import()
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_asesi/v_asesi-import', $data);
		$this->load->view('template/footer');
	}
	...
	public function template()
	{
		$spreadsheet = new Spreadsheet();
		$sheet = $spreadsheet->getActiveSheet();
		$sheet->setCellValue('A1', 'TEMPLATE ASESI');
		$sheet->mergeCells('A1:F1');

		$sheet->setCellValue('A2', 'No Peserta');
		$sheet->setCellValue('B2', 'Nama Lengkap');
		$sheet->setCellValue('C2', 'Kelas');
		$sheet->setCellValue('D2', 'Tahun Aktif');
		$sheet->setCellValue('E2', 'Nama Pengguna');
		$sheet->setCellValue('F2', 'Kata Sandi');
		...
		$sheet->getStyle('A2:F3')->applyFromArray($styleArray);

		$writer = new Xlsx($spreadsheet);
		$filename = "Template Data Asesi";
