...
class Skemaasesor extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('v_skema-asesor/v_skema', $data);
	...
	public function detail($idskema)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_skema-asesor/v_skema-detail', $data);
		$this->load->view('template/footer');
	}
	...
	public function unit($idskema)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_skema-asesor/v_skema_unit', $data);
		$this->load->view('template/footer');
	}
	...
	public function elemen($idunit)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_skema-asesor/v_skema_elemen', $data);
		$this->load->view('template/footer');
	}
	...
	public function tambah()
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_skema-asesor/v_skema-add', $data);
		$this->load->view('template/footer');
	}
	...
	public function ubah($idskema)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_skema-asesor/v_skema-edit', $data);
		$this->load->view('template/footer');
	}
	...
	public function export()
	{
		...
		try {
			...
			$spreadsheet->getProperties()
				...
				->setDescription(
					"Data Asesor LSP P1 SMKN 4 GARUT"
				)
			...
			$sheet->setCellValue('A2', 'LSP P1 SMK NEGERI 4 GARUT ');
	...
	public function tambah_unit($idskema)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_skema-asesor/v_skema_unit-add', $data);
		$this->load->view('template/footer');
	}
	...
	public function ubah_unit($idunit)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_skema-asesor/v_skema_unit-edit', $data);
		$this->load->view('template/footer');
	}
	...
	public function tambah_elemen($idunit)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_skema-asesor/v_skema_elemen-add', $data);
		$this->load->view('template/footer');
	}
	...
	public function ubah_elemen($idelemen)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_skema-asesor/v_skema_elemen-edit', $data);
		$this->load->view('template/footer');
	}
	...
	public function tambah_kuk($idelemen)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_skema-asesor/v_skema_kuk-add', $data);
		$this->load->view('template/footer');
	}
	...
	public function ubah_kuk($idkuk)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar', $data);
		$this->load->view('v_skema-asesor/v_skema_kuk-edit', $data);
		$this->load->view('template/footer');
	}
